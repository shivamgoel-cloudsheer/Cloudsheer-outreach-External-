...
// All sign-in / sign-up flows route through this page only. The button posts a
// server action that kicks off Google OAuth and lands the user on the dashboard.
  ...
  return (
    ...
    >
      <button
        ...
        className={
          variant === "primary"
            ? "inline-flex items-center gap-3 rounded-xl border border-slate-200 bg-white px-6 py-3.5 text-sm font-semibold text-slate-800 shadow-sm transition hover:-translate-y-0.5 hover:bg-slate-50 hover:shadow-md"
            : "inline-flex items-center gap-2 rounded-lg px-3 py-1.5 text-sm font-medium text-slate-600 transition hover:text-slate-900"
        }
      >
    ...
    <div className="min-h-screen flex-1 bg-slate-50 text-slate-900">
      ...
      <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/80 backdrop-blur">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-3.5">
          ...
          <GoogleSignIn label="Sign in" variant="ghost" />
        </div>
      </header>
